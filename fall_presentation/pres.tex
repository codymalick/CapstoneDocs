...
\begin{frame}[allowframebreaks]
	...
	The performance of Ciao's SDN is one of the most important parts of the 
	project.
	We will measure performance based on bandwidth and latency.
\end{frame}

\begin{frame}[allowframebreaks]
	\frametitle{Bandwidth Testing}
	Bandwidth testing goes here
\end{frame}

\begin{frame}[allowframebreaks]
	\frametitle{Latency Testing}
	Latency testing goes here
\end{frame}
